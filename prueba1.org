...
#+date: \today
#+author: Andre Rosero, Ricardo León, Mauro Valencia, David Paredes, Adrían Trujillo, Juan Jácome
#+email: andre.rosero@epn.edu.ec, ricardo.leon02@epn.edu.ec, mauro.valencia@epn.edu.ec; david.paredes01@epn.edu.ec, adrian.trujillo@epn.edu.ec
#+LATEX_CLASS: beamer
...
:BEAMER_env: block
:END:
 El dispositivo envia una señal de interrupción al procesador
...
:END:
 ...
 antes de responder a la interrupción.

*** Paso 3
:PROPERTIES:
:BEAMER_env: block
:END:
 El procesador comprueba la existencia de interrupciones e identifica
la interrupción activa.  
Posteriormente, envía una señal de reconocimiento (*acknowledge*) al
dispositivo que originó la interrupción, provocando que este desactive
...
- El estado del procesador $\rightarrow$ La Palabra de Estado del Programa (PSW, *Program Status Word*).
...
A partir de este momento, el control de la ejecución se transfiere a dicha rutina.
...
:BEAMER_col: 0.6
:END:
*Paso 6:* La rutina de servicio de interrupción guarda en la pila de control los
contenidos de los registros del procesador, ya que estos pueden ser
utilizados durante la atención de la interrupción.

Este paso asegura la preservación completa del estado del programa
interrumpido.

*Paso 7:* La rutina de servicio de interrupción procesa el evento que originó la
interrupción. Esto puede incluir:

- Examinar el estado del dispositivo de E/S.
- Transferir datos entre el dispositivo y la memoria.
- Enviar señales o comandos adicionales al dispositivo para finalizar
...
*Paso 8:* Una vez finalizado el procesamiento de la interrupción, los valores de los
registros almacenados se recuperan desde la pila de control y se restauran
en los registros del procesador.

*Paso 9:* Posteriormente, se recuperan desde la pila la Palabra de Estado del Programa
(PSW) y el Contador de Programa (PC). Como resultado, el procesador reanuda
la ejecución del programa previamente interrumpido a partir de la siguiente
instrucción.
